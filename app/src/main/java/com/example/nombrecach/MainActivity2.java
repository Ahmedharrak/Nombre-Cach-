...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx11 = findViewById(R.id.edit_view3);
        tx = findViewById(R.id.edit_view4);
        ed = findViewById(R.id.edit_text2);
        ed.setFilters(new InputFilter[]{ new InputFilterMinMax("1", "100")});
